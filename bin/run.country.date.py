...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Find just those ids with a country, date, latlon and print them')
    ...
    print("Run ID\tCountry\tDate\tLat Lon")
    for r in srr:
        print("{}\t{}\t{}\t{}".format(r, srr[r][0], srr[r][1], srr[r][2]))
